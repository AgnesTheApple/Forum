			...
			<div class="discussion">
				<form class="formu" method="POST" action="">
					<table>
						<tr>
							<td>
								<textarea class="texte" type="text" placeholder="Envoyer un message" id="message" name="message" rows="4" cols="50"></textarea>
							</td>
						</tr>
					</table>
					<input class="envoie" type="submit" name="envoie"/><br/>
				</form>
			</div>
		</div>
	</body>
